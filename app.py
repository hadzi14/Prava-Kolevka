...
DOMAIN_BOOST = {
    "Radno pravo": {
        "central": [
            ...
            "zarada", "naknada zarade",
            "neisplaćen", "neisplacen",
            "godišnji odmor", "godisnji odmor",
            "tehnološki višak", "tehnoloski visak",
            "otkazni rok",
            "vraćanje na posao", "vracanje na posao",
            "naknada štete", "naknada stete",
            "disciplinski postupak",
            "izjašnjenje zaposlenog",
            "izjasnjenj",
            "zaštita zaposlenog", "zastita zaposlenog",
            "prava zaposlenog",
            "procedura otkaza",
            "ugovor o radu",
            "radni odnos",
        ...
        "peripheral": [
            "zaštita omladine", "zastita omladine",
            "raspoređivanje", "rasporedjivanj",
            "promena poslodavca",
    ...
    "Krivično pravo": {
        "central": [
            "krivično delo", "krivicno delo",
            "kazna zatvora", "novčana kazna",
            "novcana kazna",
            "učinilac", "ucinilac",
            "umišljaj", "umisljaj",
            "nehat",
            "nužna odbrana", "nuzna odbrana",
            "krajnja nužda", "krajnja nuzda",
            "saučesništvo", "saučesnik",
            "krivična odgovornost",
            "krivicna odgovornost",
            "recidivizam",
            "maloletnički", "maloletnick",
            "korupcij",
            "pronevera",
            "ubistvo", "telesna povreda",
            "krađa", "kradja",
            "prevara", "iznuda",
            "razbojništvo", "razbojnistvo",
            "falsifikovanje",
            "nasilje u porodici",
        ],
        "peripheral": [
    ...
    "Krivični postupak": {
        "central": [
            ...
            "glavni pretres",
            "okrivljeni",
            "osumnjičen", "osumnjicen",
            "branilac",
            "tužilac", "tuzilac",
            "presuda",
            "žalba na presudu", "zalba na presudu",
            "dokaz", "dokazni postupak",
            "veštačenje", "vestacenje",
            "svedok", "saslušanje",
            "pretres stana",
            "privremeno oduzimanje",
            "sporazum o priznanju",
            "skraćeni postupak", "skraceni postupak",
            "redovni pravni lek",
            "vanredni pravni lek",
        ],
        "peripheral": [
    ...
    "Porodično pravo": {
        "central": [
            "razvod braka",
            "bračna zajednica", "bracna zajednica",
            "alimentacija",
            "izdržavanje", "izdrzavanje",
            "starateljstvo", "starateljstv",
            "roditeljsko pravo",
            "zajednička imovina",
            "zajednicka imovina",
            "dete", "deca",
    ...
    "Imovinsko pravo": {
        "central": [
            "pravo svojine",
            "vlasništvo", "vlasnistv",
            "posed",
            "nepokretnost",
            "katastar",
            "eksproprijacija",
            "uzurpacija",
            "suvlasništvo", "suvlasnistvo",
            "pravo plodouživanja",
            "pravo plodouzivanja",
            "pravo prolaza",
            "hipoteka",
